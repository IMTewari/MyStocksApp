...
type HoldingRow = {
  ...
  last_price: number; // Fix A: required number
};
...
export default function Dashboard() {
  ...
  return (
    <main>
      ...
      <div style={{ marginBottom: 16, color: '#666' }}>Valuation: ₹{Math.round(valuation).toLocaleString()}</div>
            ...
            <div key={r.tradingsymbol} style={{ border: '1px solid #ddd', borderRadius: 8, padding: 12 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  ...
                  <div style={{ fontSize: 12, color: '#666' }}>Qty {r.quantity} · Avg ₹{r.average_price} · Alloc {allocationPct}%</div>
                </div>
